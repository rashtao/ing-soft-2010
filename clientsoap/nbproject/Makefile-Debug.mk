...
LDLIBSOPTIONS=-lfltk -lfltk_forms -lfltk_gl -lfltk_images

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/clientsoap

dist/Debug/GNU-Linux-x86/clientsoap: ${OBJECTFILES}
...
${OBJECTDIR}/Presentation/PContactList.o: nbproject/Makefile-${CND_CONF}.mk Presentation/PContactList.cpp 
	${MKDIR} -p ${OBJECTDIR}/Presentation
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Presentation/PContactList.o Presentation/PContactList.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/clientsoap
